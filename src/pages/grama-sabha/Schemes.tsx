...
const Schemes: React.FC = () => {
  ...
  const handleExportCSV = async () => {
    try {
      ...
      a.href = url;
      a.download = 'grama-sabha-scheme-eligibility.csv';
      ...
      >
        <div className="relative z-10">
          <h1 className="text-3xl font-bold mb-2 flex items-center">
            ...
            Village Scheme Eligibility
          </h1>
          <p className="text-emerald-100 text-lg">
            Track beneficiary eligibility for FRA schemes and government programs at village level
          </p>
        </div>
      ...
      >
        <div className="flex items-center justify-between mb-6">
          <h3 className="text-lg font-semibold text-gray-900 dark:text-white">
            Village Scheme Eligibility Details
          </h3>
          ...
          <div className="text-center py-12">
            ...
            <p className="text-gray-600 dark:text-gray-400">
              {searchTerm || eligibilityFilter !== 'all'
                ...
                : 'No scheme eligibility data available for this village'
              }
            </p>
          </div>
        ) : (

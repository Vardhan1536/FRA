...
const Schemes: React.FC = () => {
  ...
  const handleExportCSV = async () => {
    try {
      ...
      a.href = url;
      a.download = 'sdlc-scheme-eligibility.csv';
      ...
      >
        <div className="relative z-10">
          <h1 className="text-3xl font-bold mb-2 flex items-center">
            ...
            State Scheme Eligibility Analysis
          </h1>
          <p className="text-amber-100 text-lg">
            Comprehensive analysis of FRA scheme eligibility across all beneficiaries and districts
          </p>
        </div>
      ...
      >
        <div className="flex items-center justify-between mb-6">
          <h3 className="text-lg font-semibold text-gray-900 dark:text-white">
            State Scheme Eligibility Details
          </h3>
          <div className="flex items-center space-x-3">
            <div className="relative">
              ...
              <input
                ...
                className="pl-10 pr-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-amber-500 focus:border-transparent"
              />
            </div>
            <select

...
const SDLCCheckPatta: React.FC = () => {
  ...
  // Mock data for SDLC - documents forwarded from GramaSabha
  const mockPattaDocuments: PattaDocument[] = [
    {
      ...
      verificationNotes: 'Forwarded from GramaSabha for SDLC review',
    ...
    },
    {
      ...
      verificationNotes: 'Approved by SDLC after thorough review',
    ...
    },
    {
      ...
      verificationNotes: 'Forwarded to DLC for final approval and digitalization',
      verifiedBy: 'SDLC Officer',
    ...
    },
    {
      ...
      gramaSabhaApproved: true,
      sdlcReviewStatus: 'Forwarded',
      verificationNotes: 'Successfully digitalized and approved',
  ...
  const handleVerification = async (documentId: string, decision: 'approve' | 'reject' | 'forward') => {
    try {
      const updatedDocuments = pattaDocuments.map(doc => {
        if (doc.id === documentId) {
          ...
          return {
            ...doc,
            status: newStatus,
            sdlcReviewStatus: (decision === 'approve' ? 'Approved' : decision === 'reject' ? 'Rejected' : 'Forwarded') as 'Approved' | 'Rejected' | 'Forwarded' | 'Pending',
      ...
      // If forwarding to DLC, save to localStorage for DLC to access
      if (decision === 'forward') {
        ...
        if (forwardedDoc) {
          ...
          dlcDocuments.unshift(forwardedDoc);
          localStorage.setItem('dlcPattaDocuments', JSON.stringify(dlcDocuments));
        }
      }
      
      // Update localStorage for SDLC documents
      localStorage.setItem('sdlcPattaDocuments', JSON.stringify(updatedDocuments));
      ...
      alert(`Document ${decision === 'approve' ? 'approved' : decision === 'reject' ? 'rejected' : 'forwarded to DLC'} successfully!`);
    } catch (error) {
      ...
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold text-gray-900 dark:text-white">
            Check Patta Documents - SDLC
          </h1>
          <p className="text-gray-600 dark:text-gray-400">
            Review patta documents forwarded from GramaSabha
          </p>
        </div>
        ...
        <div className="flex flex-col lg:flex-row gap-4">
          ...
          <div className="flex gap-4">
            ...
            >
              ...
              <option value="Forwarded to SDLC">Pending Review</option>
              <option value="Approved">Approved</option>
              <option value="Rejected">Rejected</option>
              <option value="Forwarded to DLC">Forwarded to DLC</option>
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-gray-900 dark:text-white">
                {pattaDocuments.filter(doc => doc.status === 'Forwarded to SDLC').length}
              </p>
            </div>
              ...
              >
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    {document.status === 'Forwarded to SDLC' && (
                      <motion.button
                        whileHover={{ scale: 1.05 }}
                        onClick={() => {
                          setSelectedDocument(document);
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          ...
          >
            ...
            <div className="p-6 space-y-6">
              ...
              {/* Action Buttons */}
              {selectedDocument.status === 'Forwarded to SDLC' && (
            ...
            <div className="p-6">
              <div className="mb-4">
                ...
                <textarea
                  ...
                  placeholder={`Enter notes for ${verificationDecision === 'approve' ? 'approval' : verificationDecision === 'reject' ? 'rejection' : 'forwarding'}...`}
                />
              </div>
